...
def transfer_money(request):
    if request.method == 'POST':
        ...
        try:
            from_account = UserBankAccount.objects.get(account_no=from_account_number)
        ...
        if from_account.balance < amount:
            messages.error(request, "Bank is bankrupt. Insufficient funds.")
            return render(request,'transfer_amount.html')
        ...
        messages.success(request, f"Transfer of {amount}$ from {from_account_number} to {to_account_number} successful.")
        return render(request,'transfer_amount.html')
...
def withdraw_money(request):
    if request.method == 'POST':
        ...
        # messages.success(request, f"Withdrawal of {amount}$ from account {account_number} successful.")
        # return render(request, 'withdraw_money.html')
